<template>
  <div class="space-y-6">
    ...
    <div>
      <Input v-model="phoneNumber" label="Phone" placeholder="+1 (555) 000-0000" :inputClass="'pl-[84px]'">
      <template #prepend>
        <div class="absolute">
    ...
    <div>
      <Input v-model="phoneNumber2" label="Phone" placeholder="+1 (555) 000-0000" :inputClass="'pr-[84px]'">
      <template #append>
