<template>
  <div>
    <label v-if="label" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">{{ label }}</label>
    <div class="relative">
      <flat-pickr v-model="innerValue" :config="mergedConfig" :placeholder="placeholder"
