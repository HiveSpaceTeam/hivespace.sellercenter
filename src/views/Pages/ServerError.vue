<template>
  <div class="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
    ...
    <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[562px]">
      ...
      <p class="mt-10 mb-6 text-base text-gray-700 dark:text-gray-400 sm:text-lg"> We can’t seem to find the page you
        are looking for! </p>
      <a href="/"
...
// This view intentionally has minimal logic; purely presentational
</script>
