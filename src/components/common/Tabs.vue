<template>
  <div class="relative">
    ...
    <div v-if="variant === 'default'" class="absolute bottom-0 left-0 w-full h-0.5 bg-gray-200 dark:bg-gray-700" />
...
withDefaults(defineProps<{ options: { label: string; value: string }[]; modelValue: string; variant?: 'default' | 'pills' }>(), { variant: 'default' })
