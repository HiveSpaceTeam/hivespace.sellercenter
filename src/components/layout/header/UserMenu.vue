<template>
  <div class="relative" ref="dropdownRef">
    ...
    <div v-if="dropdownOpen"
      ...
      <div @click="signOut"
        class="flex items-center cursor-pointer gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
